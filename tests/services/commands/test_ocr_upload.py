...
def test_upload_file(cmd, sample_pdf, factory):
    upload_id = cmd.upload_file(sample_pdf)
...
def test_upload_duplicate_returns_same_id(cmd, sample_pdf):
    id1 = cmd.upload_file(sample_pdf)
    id2 = cmd.upload_file(sample_pdf)
    assert id1 == id2
...
def test_upload_and_process(cmd, sample_pdf, factory):
    upload_id = cmd.upload_and_process(sample_pdf)
